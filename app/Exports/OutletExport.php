...
class OutletExport implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        ...
        $data['rows'] = DB::select("EXEC SP_TreeViewDashBoard 'D','".$this->Region."','".$this->Outlet."','','','','','".$this->DateFrom1."','".$this->DateTo1."','".$this->DateFrom2."','".$this->DateTo2."','$user_id','$this->CustomerCode' ");
