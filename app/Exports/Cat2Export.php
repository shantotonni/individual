...
class Cat2Export implements FromCollection, WithHeadings
{
    protected $DateFrom1;
    protected $DateTo1;
    protected $DateFrom2;
    ...
    public function collection()
    {
        ...
        '".$this->Cat1."','".$this->Cat2."','','".$this->DateFrom1."','".$this->DateTo1."','".$this->DateFrom2."','".$this->DateTo2."','$user_id','$this->CustomerCode'");
